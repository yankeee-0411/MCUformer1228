...
class AttentionSuper(nn.Module):
    ...
    def __init__(
        ...
        if change_qkv:
            ...
            self.qkv1 = qkv_super(
                super_embed_dim, int(rank_ratio_attn * super_embed_dim), bias=False
            )

            # self.qkv2 = qkv_super(
            #     int(rank_ratio * super_embed_dim),
            #     int(rank_ratio * super_embed_dim),
            #     bias=False,
            # )

            self.qkv3 = qkv_super(
                int(rank_ratio_attn * super_embed_dim),
                3 * super_embed_dim,
                bias=qkv_bias,
                )
            ...
            self.qkv1 = LinearSuper(
                super_embed_dim, int(rank_ratio_attn * super_embed_dim), bias=False
            )

            # self.qkv2 = LinearSuper(
            #     int(rank_ratio * super_embed_dim),
            #     int(rank_ratio * super_embed_dim),
            #     bias=False,
            # )

            self.qkv3 = LinearSuper(
                int(rank_ratio_attn * super_embed_dim),
                3 * super_embed_dim,
                bias=qkv_bias,
            )
        ...
        # self.proj1 = LinearSuper(
        #     super_embed_dim, int(rank_ratio_attn * super_embed_dim), bias=False
        # )
        # # self.proj2 = LinearSuper(
        # #     int(rank_ratio * super_embed_dim),
        # #     int(rank_ratio * super_embed_dim),
        # #     bias=False,
        # # )
        
        # self.proj3 = LinearSuper(
        #     int(rank_ratio_attn * super_embed_dim), super_embed_dim
        # )
    ...
    def set_sample_config(
        ...
        #     sample_in_dim=self.sample_in_embed_dim,
        #     sample_out_dim=3 * self.sample_qk_embed_dim,
        # )

        self.proj.set_sample_config(
            sample_in_dim=self.sample_qk_embed_dim,
            sample_out_dim=self.sample_in_embed_dim,
        )


        self.qkv1.set_sample_config(
            sample_in_dim=sample_in_embed_dim,
            sample_out_dim=int(self.rank_ratio_attn * self.sample_qk_embed_dim),
        )
        # self.qkv2.set_sample_config(
        #     sample_in_dim=int(self.rank_ratio * self.sample_qk_embed_dim),
        #     sample_out_dim=int(self.rank_ratio * self.sample_qk_embed_dim),
        # )
        self.qkv3.set_sample_config(
            sample_in_dim=int(self.rank_ratio_attn * self.sample_qk_embed_dim),
            sample_out_dim=3 * self.sample_qk_embed_dim,
        )
        ...
        # self.proj1.set_sample_config(
        #     sample_in_dim=self.sample_qk_embed_dim,
        #     sample_out_dim=int(self.rank_ratio_attn * self.sample_qk_embed_dim),
        # )
        # # self.proj2.set_sample_config(
        # #     sample_in_dim=int(self.rank_ratio * self.sample_qk_embed_dim),
        # #     sample_out_dim=int(self.rank_ratio * self.sample_qk_embed_dim),
        # # )
        # self.proj3.set_sample_config(
        #     sample_in_dim=int(self.rank_ratio_attn * self.sample_qk_embed_dim),
        #     sample_out_dim=self.sample_in_embed_dim,
        # )
    ...
    def calc_sampled_param_num(self):
        num = 0
        # num += self.qkv1.calc_sampled_param_num()
        # num += self.qkv2.calc_sampled_param_num()
        # num += self.qkv3.calc_sampled_param_num()
        # num += self.proj1.calc_sampled_param_num()
        # num += self.proj2.calc_sampled_param_num()
        # num += self.proj3.calc_sampled_param_num()
        return num
